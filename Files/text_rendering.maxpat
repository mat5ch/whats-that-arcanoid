...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.199997, 201.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.399994, 152.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 152.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "prepend text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 56.0, 45.0, 20.0 ],
					"style" : "",
					"text" : "Text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 240.0, 86.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 56.0, 151.0, 20.0 ],
					"style" : "",
					"text" : "Init font settings via bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.399994, 56.0, 68.0, 20.0 ],
					"style" : "",
					"text" : "Font size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.199997, 56.0, 55.0, 20.0 ],
					"style" : "",
					"text" : "Position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.399994, 86.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.199997, 86.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 288.0, 170.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 203.0, 48.0, 23.0 ],
					"style" : "",
					"text" : "fontlist"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 266.0, 74.0, 23.0 ],
					"style" : "",
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 298.0, 85.0, 23.0 ],
					"style" : "",
					"text" : "prepend font"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 99.199997, 401.0, 298.0, 23.0 ],
					"style" : "",
					"text" : "jit.gl.text @color 1 1 1 1 @fontsize 40 @align 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 25.0, 100.0, 20.0 ],
					"style" : "",
					"text" : "Text rendering"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 357.5, 255.0, 297.5, 255.0 ],
					"source" : [ "obj-100", 1 ]
				}
